  ...
  return (
    <article className="grid items-center gap-10 border-t py-16 first:border-t-0 first:pt-0 last:pb-0 lg:grid-cols-2 lg:gap-20 lg:py-24">
      <div className={index % 2 ? "lg:order-2" : ""}>
        <p className="mb-4 text-xs font-semibold tracking-[.16em] text-muted uppercase">Concept Project · 0{index + 1}</p>
        ...
        <dl className="mt-8 space-y-6">
          ...
          <div><dt className="mb-2 text-sm font-semibold">Demonstrated result</dt><dd className="leading-7 text-muted">{project.result}</dd></div>
        </dl>
