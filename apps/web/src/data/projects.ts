...
export const projects: CaseStudy[] = [
  {
    ...
    context: "A premium furniture ecommerce concept designed to make a large catalog feel refined and easy to shop.",
    ...
    visual: "furniture",
    image: { src: "/images/projects/furniture-store.png", alt: "Concept interface for a refined furniture ecommerce store" },
  },
  {
    title: "Architecture Company WordPress Site",
    context: "A clear corporate publishing concept for projects, services, expertise, and editorial content.",
    ...
    visual: "architecture",
    image: { src: "/images/projects/architecture-site.png", alt: "Concept website interface for a contemporary architecture practice" },
  },
  {
    title: "SaaS Project Management Dashboard",
    context: "An authenticated workspace concept for small teams to coordinate projects and tasks.",
    ...
    result: "An authenticated dashboard concept with understandable project and task workflows across screen sizes.",
    capabilities: ["Next.js", "NestJS", "PostgreSQL", "Dashboard UX"],
    visual: "dashboard",
    image: { src: "/images/projects/project-dashboard.png", alt: "Concept project management dashboard interface" },
  },
];
